...
class CreateProduct extends Form {
  ...
  doSubmit = async () => {
    try {
      ...
      toast.success("your new product was been created successfully");
  ...
  render() {
    ...
    if (!user || (!user.isAdmin && !user.biz))
      return <Navigate replace to="/login" />;

    const { isCardCreated } = this.state;
    if (isCardCreated) return <Navigate replace to="/my-products" />;
      ...
      >
        <div className="container">
          <PageHeader
            ...
            subTitle="Here you can create a product for sale"
          />
          <div className="center">
            ...
            >
              ...
              Category
              <br />
              <select defaultValue = "women" onChange={this.categoryChange}>
              ...
              Subcategory
              <br />
              <select defaultValue = "dresses" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "women") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "hoodies" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "men") ? 'block' : 'none' }}>
                <option value="hoodies" >Hoodies &amp; Sweatshirts</option>
                <option value="tanks" >T-shirts</option>
                <option value="suits" >Casual Shorts</option>
                <option value="sets" >Men's Sets</option>
                <option value="coats" >Jackets</option>
              </select>
              <select defaultValue = "android" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "phones") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "cpus" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "office") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "cables" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "electronic") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "silver" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "jewelry") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "fabric" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "home") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "totes" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "bags") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "dresses" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "toys") ? 'block' : 'none' }}>
                <option value="dresses" >Dresses</option>
              ...
              <select defaultValue = "swimming" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "outdoor") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "bundle-closure" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "beauty") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "lights" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "automobiles") ? 'block' : 'none' }}>
              ...
              <select defaultValue = "analysis" onChange={this.subcategoryChange} style={{display: (this.state.data.category === "tools") ? 'block' : 'none' }}>
              ...
              Free Return
              <br />
              <select defaultValue = "no" onChange={this.returnChange}>
