      ...
      <div style={{  display: 'flex', flexDirection: 'row', justifyContent: 'center',paddingBottom: "5vh"}}>
        ...
        <ProSidebar style={{marginTop: "2vh"}}>
          <Menu iconShape="square">
            ...
            <SubMenu title="Women's Fashion" icon={<FaHeart />}>
            ...
            <SubMenu title="Men's Fashion" icon={<FaHeart />}>
              <MenuItem>Hoodies &amp; Sweatshirts<Link to="/cat-order-converter" state={{ cat: "hoodies" }}></Link></MenuItem>
            ...
            <SubMenu title="Phones &amp; Telecommunications" icon={<FaHeart />}>
            ...
            <SubMenu title="Computer, Office &amp; Security" icon={<FaHeart />}>
            ...
            <SubMenu title="Consumer Electronics" icon={<FaHeart />}>
            ...
            <SubMenu title="Jewelry &amp; Watches" icon={<FaHeart />}>
            ...
            <SubMenu title="Home,Pet &amp; Appliances" icon={<FaHeart />}>
            ...
            <SubMenu title="Bags &amp; Shoes" icon={<FaHeart />}>
            ...
            <SubMenu title="Toys , Kids &amp; Babies" icon={<FaHeart />}>
              <MenuItem>Dresses<Link to="/cat-order-converter" state={{ cat: "dresses" }}></Link></MenuItem>
            ...
            <SubMenu title="Outdoor Fun &amp; Sports" icon={<FaHeart />}>
            ...
            <SubMenu title="Beauty, Health &amp; Hair" icon={<FaHeart />}>
            ...
            <SubMenu title="Automobiles &amp; Motorcycles" icon={<FaHeart />}>
            ...
            <SubMenu title="Home Improvement &amp; Tools" icon={<FaHeart />}>
